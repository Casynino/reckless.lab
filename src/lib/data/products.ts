...
export const products: Product[] = [
  // ── "I EXIST" SERIES ──────────────────────────────────────────────
  {
    ...
    order: 1,
    media: [
      { src: img("T-1", 16), alt: "‘Reckless’ tee, washed blue — front RECKLESS print" },
      { src: img("T-1", 14), alt: "‘Reckless’ tee, washed blue — back I EXIST print" },
      { src: img("T-1", 2), alt: "‘Reckless’ tee, washed blue — full look" },
      { src: img("T-1", 12), alt: "‘Reckless’ tee — RECKLESS print detail" },
      { src: img("T-1", 6), alt: "‘Reckless’ tee — 555 hem detail" },
    ],
  ...
  },
  {
    ...
    order: 2,
    media: [
      { src: img("T-3", 6), alt: "‘Reckless’ tee, washed grey — front RECKLESS print" },
      { src: img("T-3", 13), alt: "‘Reckless’ tee, washed grey — back I EXIST print" },
      { src: img("T-3", 22), alt: "‘Reckless’ tee, washed grey — layered longsleeve styling" },
      { src: img("T-3", 2), alt: "‘Reckless’ tee, washed grey — full look" },
      { src: img("T-3", 28), alt: "‘Reckless’ tee — waistline detail" },
    ],
  ...
  {
    id: "rs-blk",
    slug: "identity-tee-washed-black",
    name: "‘Identity’ Tee",
    subtitle: "Graphic heavyweight · washed",
    price: 35,
    gender: "unisex",
    collections: ["identity", "new-arrivals", "essentials", "limited-drops", "men", "women"],
    colorway: "Washed Black",
    isNew: true,
    isLimited: true,
    order: 4,
    media: [
      { src: img("T-4", 2), alt: "‘Identity’ tee, washed black — front" },
      { src: img("T-4", 13), alt: "‘Identity’ tee, washed black — print detail" },
      { src: img("T-4", 7), alt: "‘Identity’ tee, washed black — full look with flannel" },
      { src: img("T-4", 10), alt: "‘Identity’ tee, washed black — back" },
      { src: img("T-4", 16), alt: "‘Identity’ tee, washed black — styled" },
    ],
