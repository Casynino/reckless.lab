...
export const primaryNav: { label: string; href: string; meta: string }[] = [
  ...
  { label: "The Reckless Series", href: "/collections/reckless", meta: "SET//03" },
  { label: "Limited Drops", href: "/collections/limited-drops", meta: "LAB//00" },
  { label: "Essentials", href: "/collections/essentials", meta: "LAB//03" },
  { label: "All Collections", href: "/collections", meta: "INDEX" },
];
